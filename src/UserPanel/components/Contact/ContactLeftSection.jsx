...
function ContactLeftSection() {
  return (
<div className="p-10 pt-14 w-1/2">
          ...
          <ul className="space-y-4 mb-8">
            <li>
              ...
              <p>Request new products you require that you did not find on our website.</p>
            </li>
            <li>
              <h3 className="text-xl font-semibold">Provide Your Valuable Feedback</h3>
              <p>Your feedback is important! Tell us how we can do better..</p>
            </li>
            <li>
              <h3 className="text-xl font-semibold">Website Information</h3>
              <p>Seek guidance from our professionals regarding your web experience!</p>
            </li>
          </ul>
          <div>
            ...
            <address className="not-italic space-y-4">
              ...
              <div>
                ...
                <p>Email: <a href="mailto:partnermarketing@bytebazaar.com" className="text-blue-500">partnermarketing@bytebazaar.com</a></p>
              </div>
              <div>
                <h3 className="text-xl font-semibold">Support</h3>
                <p>Email: <a href="mailto:support@bytebazaar.com" className="text-blue-500">support@bytebazaar.com</a></p>
              </div>
