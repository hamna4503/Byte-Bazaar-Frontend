...
export default function Sidebar(){
    return (
      <>
        {/* Sidebar */}
        <div className="fixed flex flex-col top-17 left-0 w-12 hover:w-64 md:w-64 bg-Purple h-full text-white transition-all duration-300 border-none z-10 sidebar">
